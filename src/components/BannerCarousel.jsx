...
const BannerCarousel = () => (
  ...
  <Carousel fade interval={3000}>
    <Carousel.Item>
      <div className="hero-bg" style={{ backgroundImage: `url(${banner1})` }}></div>
    ...
    <Carousel.Item>
      <div className="hero-bg" style={{ backgroundImage: `url(${banner2})` }}></div>
      <div className="container hero-content">
    ...
    <Carousel.Item>
      <div className="hero-bg" style={{ backgroundImage: `url(${banner3})` }}></div>
      <div className="container hero-content">
    ...
    <Carousel.Item>
      <div className="hero-bg" style={{ backgroundImage: `url(${banner4})` }}></div>
      <div className="container hero-content">
